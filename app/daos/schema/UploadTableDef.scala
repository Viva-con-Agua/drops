...
/**
  ...
  */
class UploadTableDef(tag: Tag) extends Table[(Long, UUID, Option[UUID], String, String, Int, Int, Blob, String, Boolean)](tag, "Upload") {
  ...
  def * = (id, publicId, parentId, name, contentType, width, height, data, email, selected)
