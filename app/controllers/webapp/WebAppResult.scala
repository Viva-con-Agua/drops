...
class WebAppResult(request: RequestHeader, code: play.api.mvc.Results.Status, msg: String, msgValues: List[String], internalStatusCode: String, additional: JsValue) {
...
object WebAppResult {
  ...
  case class Generic( request: RequestHeader,  code: play.api.mvc.Results.Status,  msg: String,  msgValues: List[String],  internalStatusCode: String,  additional: JsValue) extends
    WebAppResult(request, code, msg, msgValues, internalStatusCode, additional)
  ...
  case class PasswordLinkDuringLogin( request: RequestHeader,  msg: String,  msgValues: List[String],  internalStatusCode: String, additionalMap : Map[String, String] = Map()) extends
    WebAppResult(request, play.api.mvc.Results.PreconditionFailed, msg, msgValues, internalStatusCode, Json.toJson(additionalMap))

  case class Bogus( request: RequestHeader,  msg: String,  msgValues: List[String],  internalStatusCode: String, errors: JsValue) extends
    WebAppResult(request, play.api.mvc.Results.BadRequest, msg, msgValues, internalStatusCode, errors)
  ...
  case class NotFound( request: RequestHeader,  msg: String,  msgValues: List[String],  internalStatusCode: String, additionalMap : Map[String, String]) extends
    WebAppResult(request, play.api.mvc.Results.NotFound, msg, msgValues, internalStatusCode, Json.toJson(additionalMap))
  ...
  case class Unauthorized( request: RequestHeader,  msg: String,  msgValues: List[String],  internalStatusCode: String, additionalMap : Map[String, String]) extends
    WebAppResult(request, play.api.mvc.Results.Unauthorized, msg, msgValues, internalStatusCode, Json.toJson(additionalMap))
